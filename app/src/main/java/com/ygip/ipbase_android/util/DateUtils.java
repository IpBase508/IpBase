...
public class DateUtils {
    ...
    public static String getYearStr(Date date) {
        return addZero(getInteger(date, Calendar.YEAR));
    }
    ...
    public static String getMonthStr(Date date) {
        return addZero(getInteger(date, Calendar.MONTH) + 1);
    }
    ...
    public static String getDayStr(Date date) {
        return addZero(getInteger(date, Calendar.DATE));
    }
    ...
    public static String getHourStr(Date date) {
        return addZero(getInteger(date, Calendar.HOUR_OF_DAY));
    }
    ...
    public static String getMinuteStr(Date date) {
        return addZero(getInteger(date, Calendar.MINUTE));
    }
    ...
    public static String getSecondStr(Date date) {
        return addZero(getInteger(date, Calendar.SECOND));
    }
     ...
     * @return 星期
     */
    public static WeekStyle getWeek(String date) {
        WeekStyle week = null;
        DateStyle dateStyle = getDateStyle(date);
        if (dateStyle != null) {
            Date myDate = StringToDate(date, dateStyle);
     ...
     * @return 星期
     */
    public static WeekStyle getWeek(Date date) {
        WeekStyle week = null;
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        ...
        switch (weekNumber) {
            case 0:
                week = WeekStyle.SUNDAY;
                break;
            case 1:
                week = WeekStyle.MONDAY;
                break;
            case 2:
                week = WeekStyle.TUESDAY;
                break;
            case 3:
                week = WeekStyle.WEDNESDAY;
                break;
            case 4:
                week = WeekStyle.THURSDAY;
                break;
            case 5:
                week = WeekStyle.FRIDAY;
                break;
            case 6:
                week = WeekStyle.SATURDAY;
                break;
        }
        return week;
    }
     ...
     * @param date      日期
     * @param otherDate 另一个日期
     * @return String 间隔时间，格式为1天23h3min
     */
    public static String getIntervalTime(Date date, Date otherDate) {
        date = DateUtils.StringToDate(DateUtils.getDate(date));
        long time = Math.abs(date.getTime() - otherDate.getTime());
        int interval = (int) time / (1 * 1000);// 相差分钟数
        String coutdown = Integer.toString(interval / 24 / 60 / 60) + "天"
                + Integer.toString(interval % 24 / 60 / 60) + ":"
                + Integer.toString(interval % 24 % 60 / 60) + ":"
                + Integer.toString(interval % 24 % 60 % 60);
        return coutdown;
    }
    ...
    public static enum WeekStyle {
        ...
        WeekStyle(String name_cn, String name_en, String name_enShort,
                  int number) {
