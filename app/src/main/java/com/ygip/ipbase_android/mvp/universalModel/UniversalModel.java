...
public class UniversalModel<T> extends IBaseModel {
    //这里是请求类型
    ...
    private UniversalResponseBean<T> universalResponseBean = new UniversalResponseBean<T>();
            ...
            public void onResponse(Call call, Response response) throws IOException {
                try {
                    ...
                    if (loginResponseBean != null)
                        ...
                        if (responseListener != null) {
                            responseListener.onFinish(null, new Exception("未知错误"));
                        }
                        return;
                    }
                    ...
                    if (loginBean != null) {
                        ...
                        if (responseListener != null) {
                            responseListener.onFinish(null, new Exception(loginResponseBean.getMsg() != null ? loginResponseBean.getMsg() : ""));
                        }
                        return;
                    }
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                try {
                    ...
                    responseListener.onFinish(universalResponseBean, null);
                    if (responseString != null) {
                        checkTokenVaild(responseString);
                    }
                } catch (Exception e) {
                    responseListener.onFinish(universalResponseBean, e);
                    e.printStackTrace();
                }
            }
        });
